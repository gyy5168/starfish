...
(function () {
    ...
    var each = helpers.each = function (loopable, callback, self) {
        ...
        getAngleFromPoint = helpers.getAngleFromPoint = function (centrePoint, anglePoint) {
            ...
            var d01 = Math.sqrt(Math.pow(MiddlePoint.x - FirstPoint.x, 2) + Math.pow(MiddlePoint.y - FirstPoint.y, 2)), d12 = Math.sqrt(Math.pow(AfterPoint.x - MiddlePoint.x, 2) + Math.pow(AfterPoint.y - MiddlePoint.y, 2)), fa = t * d01 / (d01 + d12),
    ...
    Chart.MultiTooltip = Chart.Element.extend({
        initialize: function () {
            ...
            var titleWidth = this.ctx.measureText(this.title).width,
                ...
                labelWidth = longestText(this.ctx, this.font, this.labels) + this.fontSize + 3, longestTextWidth = max([
                    labelWidth,
                    titleWidth
                ]);
    ...
    Chart.RadialScale = Chart.Element.extend({
        ...
        setScaleSize: function () {
            ...
            var largestPossibleRadius = min([
                    ...
                    this.width / 2
                ]), pointPosition, i, textWidth, halfTextWidth, furthestRight = this.width, furthestRightIndex, furthestRightAngle, furthestLeft = 0, furthestLeftIndex, furthestLeftAngle, xProtrusionLeft, xProtrusionRight, radiusReductionRight, radiusReductionLeft, maxWidthRadius;
    ...
    Chart.Type.extend({
        ...
        updateScaleRange: function (datapoints) {
            ...
            var scaleSizes = this.options.scaleOverride ? {
                ...
                min: this.options.scaleStartValue,
                max: this.options.scaleStartValue + this.options.scaleSteps * this.options.scaleStepWidth
            } : helpers.calculateScaleRange(valuesArray, helpers.min([
                this.chart.width,
                this.chart.height
